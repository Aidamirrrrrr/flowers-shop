export function AboutPage() {
  return (
    <>
      <h1 style={{ margin: '0 0 20px', fontSize: '1.35rem' }}>О нас</h1>

      <section className="about-section" id="about">
        <h2>Цветочная лавка</h2>
        <p>
          Мы — небольшая студия флористики с доставкой по городу. Собираем букеты
          в день заказа из свежих цветов от проверенных поставщиков. Каждая
          композиция проходит контроль перед отправкой курьеру.
        </p>
      </section>
      ...
      <section className="about-section" id="care">
        ...
        <p>
          ...
          дня, обрезайте стебли и держите букет вдали от батарей и прямого солнца.
        </p>
        <p>
      ...
      <section className="about-section">
        ...
        <p>+7 (900) 000-00-00 · demo@flowers.shop</p>
      </section>
    </>
  )
}
