  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[85dvh]">
        <DialogHeader>
          <DialogTitle>{mode === 'create' ? 'Новый товар' : 'Редактировать товар'}</DialogTitle>
          <DialogDescription>
            Фото сохраняется на сервере. Категории управляются во вкладке «Категории».
          </DialogDescription>
        </DialogHeader>
        ...
        {loading ? (
          ...
          <form id="product-form" className="space-y-4" onSubmit={(e) => void handleSubmit(e)}>
        ...
        <DialogFooter>
          ...
          <Button type="submit" form="product-form" disabled={loading || saving}>
